...
urlpatterns = [
    ...
    path('order_invoice/<int:order_item_id>/', views.order_invoice, name='order_invoice'),
    path('render_to_pdf/<int:order_item_id>/',views.render_to_pdf,name='render_to_pdf'),
